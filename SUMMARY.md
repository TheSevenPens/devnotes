...
* [Pen input on Windows](pen-input-on-windows/README.md)
  * [Overview](pen-input-on-windows/pen-input/README.md)
    ...
    * [Implementation notes](pen-input-on-windows/pen-input/implementation-notes/README.md)
      * [Latency Implications](pen-input-on-windows/pen-input/implementation-notes/latency-implications.md)
      * [Wintab and Windows Ink Coexistence](pen-input-on-windows/pen-input/implementation-notes/wintab-vs-windows-ink-driver-conflict.md)
      * [Known Quirks and Gotchas](pen-input-on-windows/pen-input/implementation-notes/known-quirks-and-gotchas.md)
      * [DPI and Pen Coordinates](pen-input-on-windows/pen-input/implementation-notes/dpi-and-pen-coordinates.md)
      * [Per-Monitor V2 DPI Awareness](pen-input-on-windows/pen-input/implementation-notes/per-monitor-v2-dpi-awareness.md)
      * [WM\_POINTER Event Coalescing](pen-input-on-windows/pen-input/implementation-notes/wm-pointer-coalescing.md)
      * [WM\_POINTER Input Routing](pen-input-on-windows/pen-input/implementation-notes/framework-pen-input-routing.md)
      * [Wintab Gotchas](pen-input-on-windows/pen-input/implementation-notes/wintab-gotchas.md)
