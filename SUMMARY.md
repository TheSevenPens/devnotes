...
* [Pen input on Windows](pen-input-on-windows/README.md)
  * [Overview](pen-input-on-windows/pen-input/README.md)
    * [Challenges developing pen-aware applications on Windows](pen-input-on-windows/pen-input/challenges-developing-pen-aware-applications.md)
    ...
    * [WinPenKit](pen-input-on-windows/pen-input/unifying-pen-apis-with-pensession/README.md)
      ...
      * [Cross-framework support](pen-input-on-windows/pen-input/unifying-pen-apis-with-pensession/framework-input-routing.md)
  ...
  * [Implementation notes](pen-input-on-windows/implementation-notes/README.md)
    ...
    * [Windows pen behaviors](pen-input-on-windows/implementation-notes/windows-pen-behaviors/README.md)
      * [Disabling feedback & gestures](pen-input-on-windows/implementation-notes/windows-pen-behaviors/disable-shell-pen-feedback.md)
      * [Disable pen and touch feedback](pen-input-on-windows/implementation-notes/windows-pen-behaviors/disable-pen-and-touch-feedback.md)
      * [Disable press-and-hold right-click](pen-input-on-windows/implementation-notes/windows-pen-behaviors/disable-press-and-hold-right-click/README.md)
        * [Hide the cursor during a pen hold](pen-input-on-windows/implementation-notes/windows-pen-behaviors/disable-press-and-hold-right-click/hide-the-cursor-during-a-pen-hold.md)
      * [Windows pen & touch settings](pen-input-on-windows/implementation-notes/windows-pen-behaviors/windows-pen-touch-settings.md)
      * [Sample apps to test Windows pen behaviors](pen-input-on-windows/implementation-notes/windows-pen-behaviors/sample-apps-to-build.md)
