...
The motivation for getting this documentation together comes from the challenges I discovered: [Challenges developing pen-aware applications on windows](challenges-developing-pen-aware-applications-on-windows.md)



## APIs

* [Windows Pen API Landscape](../pen-apis/windows-pen-api-landscape.md) — Comprehensive comparison of all Windows pen input APIs (Wintab, WM\_POINTER, WinUI, WPF, RealTimeStylus)
